...
<div class="carousel-container">
  <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image/Lawang.jpg" class="d-block w-100" alt="...">
      </div>
  ...
  <div class="semarang animated animatedFadeInUp fadeInUp text-center">
      <img class="img-fluid" src="image/image 1.png" alt="" srcset="" width="45%">
      <h2>Cari Artikel,Berita,UMKM,</h2>
      <h2>dan info loker disini</h2>
      <div class="flex p-2">
          <a href="#slider" class="btn btn-dark text-decoration-none mb-2">Info Terbaru</a>
      </div>
    </div>
</div>
@endsection 
...
<section id="slider" class="">
  <div class="container">
    <h1 class="text-center mb-2"><b>Info Terbaru</b></h1>
	  <div class="slider">

...
<div class="col-lg-8">
    <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="mb-5" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Web Programming" required value="{{ old('title', $post->title) }}">
          @error('title')
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('slug') is-invalid" @enderror id="slug" name="slug" placeholder="web-programming" required value="{{ old('slug', $post->slug) }}">
          @error('slug')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
        ...
        <div class="mb-3">
          ...
          <input class="form-control" name="address" type="text" value="{{ old('body', $post->address) }}"></input>
        </div>
